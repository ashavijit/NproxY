...
usize buf_readable(const np_buf_t *b) { return b->write_pos - b->read_pos; }

usize buf_writable(const np_buf_t *b) { return b->cap - b->write_pos; }

u8 *buf_read_ptr(const np_buf_t *b) { return b->data + b->read_pos; }

u8 *buf_write_ptr(np_buf_t *b) { return b->data + b->write_pos; }
...
void buf_produce(np_buf_t *b, usize n) { b->write_pos += n; }
